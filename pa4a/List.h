...
void prepend(List L, int data); // Inserts new element before front element in this List
void append(List L, int data); //Inserts new element after back element in this List
